...
pub fun main(authorAddress: Address, readerAddress: Address): [PostMetadata] {
    ...
    for postID in postIDs {
        let post = publicRef!.borrowPost(postID: postID, readerAddress: readerAddress) ?? panic("this post does not exist")
